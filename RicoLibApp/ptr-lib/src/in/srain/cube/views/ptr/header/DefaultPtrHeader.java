...
public class DefaultPtrHeader extends FrameLayout implements PtrUIHandler {
    ...
    public DefaultPtrHeader(Context context) {
        super(context);
        initViews(null);
    }

    public DefaultPtrHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public DefaultPtrHeader(Context context, AttributeSet attrs, int defStyle) {

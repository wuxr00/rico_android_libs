...
public final class CameraManager {
    ...
    private int MIN_FRAME_WIDTH = 400;
    private int MIN_FRAME_HEIGHT = 400;
    private int MAX_FRAME_WIDTH = 700;//Constant.screenWidth
    private int MAX_FRAME_HEIGHT = 700;
    ...
    public void setSize(int minWidth, int minHeight, int maxWidth, int maxHeight) {
